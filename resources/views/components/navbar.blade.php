      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
          <div class="navbar-nav text-end" style="font-family: IBM Plex Sans, sans-serif;margin-right:20px;">
              ...
              <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 1])}}">Elettronica</a></li>
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 2])}}">Abbigliamento</a></li>
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 3])}}">Casa</a></li>
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 4])}}">Animali</a></li>
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 5])}}">Sport</a></li>
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 6])}}">Beauty</a></li>
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 7])}}">Gioielli</a></li>
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 8])}}">Libri</a></li>
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 9])}}">Fai da te</a></li>
                      <li><a class="dropdown-item text-end" href="{{route("category",["category_id" => 10])}}">Food</a></li>
          ...
          @auth
              <div class="containerBottoniNavBar">
                  <a href="{{route("article.create")}}"><button class="button_navbar_1" style="margin: 10px;"><span>Inserisci annuncio</span></button></a>
          ...
          @guest
              <div class="containerBottoniNavBar">
                  <a href="{{route("login")}}"><button class="button_navbar_1" style="margin: 10px;"><span>Login</span></button></a>
                  <a href="{{route("register")}}"><button class="button_navbar_2" style="margin: 10px;"><span>Registrati</span></button></a>
                  <div class="separatoreTastiNavBar"></div>
                  <button class="BtnCarrello">
