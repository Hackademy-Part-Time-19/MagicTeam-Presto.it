                    ...
                    <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                        <div class="col-lg-8 mx-auto col-10 custom-style-html"
                            ...
                            <div
                                ...
                                <h5 class="titoloInfoProdotto">{{ $article->name }}</h5>

                                <p class="descrizioneInfoProdotto">{{ $article->description }}</p>

                                <h2 class="prezzoInfoProdotto">{{ $article->price }}</h2>

                                <div class="containerBtnInfoProdotto">
                                    <button class="BtnAccettaArticolo approve-btn" onclick="approveArticle(this)">
                                        <div class="sign">
                                    ...
                                    <button class="BtnRifiutaArticolo delete-btn" onclick="deleteArticle(this)">
                                        <div class="sign">
                                            <svg width="17" height="17" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M15.8678 12.2513L11.6158 7.99957L15.8664 3.74833C15.9083 3.70646 15.9415 3.65675 15.9642 3.60204C15.9868 3.54733 15.9985 3.48869 15.9985 3.42947C15.9985 3.37025 15.9868 3.31161 15.9642 3.2569C15.9415 3.20218 15.9083 3.15247 15.8664 3.1106L12.8887 0.132106C12.8041 0.0475192 12.6894 0 12.5697 0C12.4501 0 12.3354 0.0475192 12.2508 0.132106L7.99946 4.38334L3.74883 0.132106C3.57971 -0.0372448 3.28024 -0.0372448 3.11089 0.132106L0.132501 3.11015C0.0480275 3.19481 0.000586546 3.30953 0.000586546 3.42913C0.000586546 3.54873 0.0480275 3.66344 0.132501 3.7481L4.38382 7.99957L0.131821 12.2515C0.0474027 12.3362 0 12.4509 0 12.5705C0 12.69 0.0474027 12.8047 0.131821 12.8894L3.10976 15.8677C3.15162 15.9096 3.20134 15.9429 3.25607 15.9656C3.3108 15.9883 3.36947 16 3.42873 16C3.48798 16 3.54665 15.9883 3.60138 15.9656C3.65612 15.9429 3.70583 15.9096 3.74769 15.8677L7.99946 11.6158L12.2515 15.8675C12.3396 15.9554 12.4546 15.9997 12.5704 15.9997C12.6863 15.9997 12.8014 15.9554 12.8896 15.8675L15.868 12.8892C15.9526 12.8046 16 12.6898 16 12.5702C16 12.4506 15.9524 12.3358 15.8678 12.2513Z"
                                                    fill="white" />
                                            </svg>
                                        </div>
