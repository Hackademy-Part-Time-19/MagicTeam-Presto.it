<x-layout>
    ...
    <div class="col-lg-8 mx-auto col-10 custom-style-html"
        ...
        <div
            style="width: 550px; height: 350px; margin: 20px 10px 20px 10px; display: flex; align-items: center; justify-content: center;">
            <img id="productImage" src="/img/default-img.gif" class="img-fluid" alt=""
                style="border-radius:10px;width: 100%; height: 100%; object-fit: cover;" onmouseover="changeImage()"
                onmouseout="restoreImage()">
        </div>

        <div style="margin: 20px 10px 20px 10px;width:450px;height:350px;display:flex;flex-direction:column;">
            <div
                style="width:100%; border-radius:50px; background-color:red; display:flex; align-items:center; justify-content:center">
    ...
    <div class="col-lg-8 mx-auto col-10 custom-style-html">
        ...
        <div class="col-lg-6 mx-auto col-10 text-center">
            <form
                ...
                <div class="col">
                    <input name="search" type="text" class="form-control custom-input"
                        placeholder="Cerca qualunque cosa!" aria-label="Cerca qualunque cosa!">
                </div>
                {{-- <div class="col">
                ...
                <div class="col">
                    <button type="submit" class="buttonSearch"><span><svg width="24" height="24"
    ...
    <div class="col-lg-8 mx-auto col-10 text-center">
        ...
        <div class="cointainerBoxCategorie">
            <div class="titoloCategoriaElettronica">
                ...
                <a href="{{ route('category', ['category_id' => 1]) }}" style="text-decoration: none;color:#1F33E5">
                    <h5> <b>Elettronica</b></h5>
                </a>
            </div>
            ...
            <div class="titoloCategoriaAbbigliamento">
                ...
                <a href="{{ route('category', ['category_id' => 2]) }}" style="text-decoration: none;color:#006837">
                    <h5> <b>Abbigliamento</b></h5>
                </a>
            </div>
            ...
            <div class="titoloCategoriaCasa">
                ...
                <a href="{{ route('category', ['category_id' => 3]) }}" style="text-decoration: none;color:#29ABE2">
                    <h5> <b>Casa</b></h5>
                </a>
            </div>
            ...
            <div class="titoloCategoriaAnimali">
                ...
                <a href="{{ route('category', ['category_id' => 4]) }}" style="text-decoration: none;color:#D4145A">
                    <h5> <b>Animali</b></h5>
                </a>
            </div>
            ...
            <div class="titoloCategoriaSport">
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none"
                    xmlns="http://www.w3.org/2000/svg" class="iconBoxCategoria">
                    <path
                ...
                <a href="{{ route('category', ['category_id' => 5]) }}" style="text-decoration: none;color:#ED1C24">
                    <h5> <b>Sport</b></h5>
                </a>
            </div>
            ...
            <div class="titoloCategoriaBeauty">
                ...
                <a href="{{ route('category', ['category_id' => 6]) }}" style="text-decoration: none;color:#E0C121 ">
                    <h5> <b>Beauty</b></h5>
                </a>
            </div>
            ...
            <div class="titoloCategoriaGioielli">
                ...
                <a href="{{ route('category', ['category_id' => 7]) }}" style="text-decoration: none;color:#00C508">
                    <h5> <b>Gioielli</b></h5>
                </a>
            </div>
            ...
            <div class="titoloCategoriaLibri">
                ...
                <a href="{{ route('category', ['category_id' => 8]) }}" style="text-decoration: none;color:#93278F">
                    <h5> <b>Libri</b></h5>
                </a>
            ...
            <div class="titoloCategoriaFaiDaTe">
                ...
                <a href="{{ route('category', ['category_id' => 9]) }}" style="text-decoration: none;color:#00A99D">
                    <h5> <b>Fai da te</b></h5>
                </a>
            </div>
            ...
            <div class="titoloCategoriaFood">
                ...
                <a href="{{ route('category', ['category_id' => 10]) }}" style="text-decoration: none;color:#ED751E">
                    <h5> <b>Food</b></h5>
                </a>
            </div>
    ...
    <div class="main_card_div_bg">
        ...
        <div class="container main_card_container">
            <div class="row justify-content-center">
                <div class="main_card_inner_container">
                    ...
                    <img id="productImage" src="/img/default-img.gif" class="img-fluid main_card_image"
                        alt="" onmouseover="changeImage()" onmouseout="restoreImage()">
        ...
        <script>
            function changeImage() {
                document.getElementById('productImage').src = '/img/default-img.gif';
            }
