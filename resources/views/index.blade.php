<x-layout>
    ...
    <div class="col-lg-8 mx-auto col-10 text-center" style="margin-top: 30px">
        <div class="containerImgTxtFormRicercaHome">
    ...
    <div class="col-lg-8 mx-auto col-10 "
        style="display: flex;flex-wrap:wrap; align-items:center; justify-content:center; margin: 70px 10px 70px 10px;">
        <div style="display:flex;justify-content:center">


            <img src="/img/vuoivendere-8.webp" alt="" class="img-fluid" style="width:330px;height:350px;margin-left:15px;margin-right:15px;">
        </div>
        <div class="boxVuoiVenedereQualcosa">
            <h2 class="vendere-h2">
