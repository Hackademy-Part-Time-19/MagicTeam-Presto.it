...
<x-layout>
    ...
    <div class="col-lg-8 mx-auto col-10 custom-style-html">
        ...
        <div class="containerImgTxtFormRicercaHome">
            <img src="/img/cerca-8.png" alt="" class="imgFormRicercaHome">
            <h1 class="txtFormRicercaHome">Cosa stai cercando?</h1>
    ...
    <div class="col-lg-8 mx-auto col-10 text-center">
        <div class="containerImgTxtFormRicercaHome">
            <h2 class="titoloRicercaCategoria">Ricerca per categorie</h2>
        </div>



        <div class="cointainerBoxCategorie">
            <div class="titoloCategoriaElettronica">
                <svg width="32" height="24" viewBox="0 0 36 28" fill="none" xmlns="http://www.w3.org/2000/svg"
                    class="iconBoxCategoria">
                    <path
    ...
    <div class="main_card_div_bg" >
        <h2 
            class="main_card_h2_titolo"
            >
            ...
            <div class="row justify-content-center">
                <div class="main_card_inner_container"
                    ...
                    <div class="main_card_category_image_div"
                        ...
                        <img class="main_card_category_image" src="/img/elettronica.svg" alt="" >
