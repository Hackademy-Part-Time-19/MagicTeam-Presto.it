            ...
            <div class="col-md-6 offset-md-3">
                <div class="card div-annuncio">
                    <div class="card-body div-annuncio">
                        ...
                        <p class="card-text text-center mb-5 sottotitolo-annuncio">Entra nella piattaforma e inizia a
                            pubblicare annunci<br><a href="{{ route('register') }}" class="sottotitolo-annuncio">Non hai
                                ancora un account?</a></p>
